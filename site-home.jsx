...
function HeroFloat({ setPage }) {
  return (
    <div style={{ position: 'relative', background: 'var(--site-cover-bg)', overflow: 'hidden',
      ...
      <h1 className="kx-hero-name" style={{ position: 'absolute', zIndex: 1, margin: 0, fontFamily: 'var(--site-display)',
      ...
      <img src={KX_IMG + 'cover-1000.webp'} alt="Kaylee Xiao" className="kx-hero-portrait" style={{ position: 'absolute', bottom: 0,
