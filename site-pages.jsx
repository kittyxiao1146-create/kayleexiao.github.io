    ...
    <>
      ...
      <div style={{ background: 'var(--site-container)' }}>
        <div className="kx-contact" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48,
          ...
          <div style={{ background: 'var(--site-form-bg)', padding: 26, borderRadius: 'var(--radius-site-lg)',
            ...
            <div style={{ display: 'flex', gap: 14 }}>
              <KXField label="First Name" required placeholder="Kaylee" style={{ flex: 1 }} />
              <KXField label="Last Name" required placeholder="Xiao" style={{ flex: 1 }} />
            </div>
            <KXField label="Email Address" type="email" required placeholder="you@email.com" />
            <KXField label="Message" multiline rows={5} required placeholder="Enter your message here." />
            <KXSiteButton type="button" onClick={() => alert('Thanks for reaching out! (demo form)')}>Send</KXSiteButton>
          </div>
        </div>
      </div>
    </>
